...
import type { UsageMonthBucket } from './MonthlyChartData'

interface MonthlyUsageCardProps {
  title: string
  dataKey: keyof Omit<UsageMonthBucket, 'label'>
  unit: string
  color: string
}
...
export default function MonthlyUsageCard({ title, dataKey, unit, color }: MonthlyUsageCardProps) {
