...
import type { InvoicePaymentMethodWire } from '@ptas/contracts'
...
interface MarkPaidModalProps {
  open: boolean
  onClose: () => void
  onConfirm: (method: InvoicePaymentMethodWire) => void | Promise<void>
}

export default function MarkPaidModal({ open, onClose, onConfirm }: MarkPaidModalProps) {
  const t = useT()
