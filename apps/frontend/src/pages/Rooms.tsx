...
export default function Rooms() {
  ...
  const [startBillRoomId, setStartBillRoomId] = useState<string | null>(null)
  ...
  const filtered = useMemo(() => {
    ...
    return allRooms.filter((entry): entry is NonNullable<typeof entry> => {
      if (!entry) return false
      const { room, tenant } = entry
