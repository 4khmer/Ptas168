...
export default function TelegramBot() {
  ...
  const t = useT()
  const { telegramLinks, loadTelegramLinks, removeTelegramLink, rooms, buildings } = useStore()
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <div className="text-[14px] font-bold text-[#0e0f0c] truncate">
                          {roomName}
                          {buildingName && <span className="text-[11px] text-[#454745] font-normal ml-1">· {buildingName}</span>}
                        </div>
